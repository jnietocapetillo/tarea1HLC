...
public class listarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // poner actores de the big bang theory
            ...
            listaActor.add(new Actor(R.drawable.sheldon,"Sheldon Cooper","Fue un niño superdotado proveniente del este de Texas. " +
                    ...
                    , "Principal"));
            listaActor.add(new Actor(R.drawable.amy,"Amy Farrah Fowler","Es la versión femenina de Sheldon. Debido a su trabajo, realiza experimentos con animales y, a veces, con Sheldon." +
            ...
            listaActor.add(new Actor(R.drawable.leonard,"Leonard Hofstadter","Es proveniente de New Jersey. Obtuvo su doctorado a los 24 años de edad en la Universidad de Princeton." +
            ...
            listaActor.add(new Actor(R.drawable.penny,"Penny","Es proveniente de Nebraska. Es camarera en el restaurante \"The Cheesecake Factory\", hasta " +
            ...
            listaActor.add(new Actor(R.drawable.howard,"Howard Wolowitz","Es judío con apariencia anticuada para su época. Es el único de los cuatro amigos que no tiene un doctorado (solo tiene un máster), " +
            ...
            listaActor.add(new Actor(R.drawable.bernadette,"Bernadette Rostenkowski","Tiene un doctorado. Se caracteriza por usar gafas y tener vestidos casuales pero similares. Es rubia, guapa y de baja estatura. " +
            ...
            listaActor.add(new Actor(R.drawable.raj,"Raj Koothrappali","Es hindú (este personaje representa el estereotipo de un hindú que reside en Estados Unidos). " +
            ...
            listaActor.add(new Actor(R.drawable.stuart,"Stuart Bloom","Tiene estudios en una escuela de Arte. Es medio nerd, fanático de los cómics y muy buen dibujante. Es el dependiente de la tienda de cómics." +
            ...
            listaActor.add(new Actor(R.drawable.emily,"Emily Sweenney","En la temporada 7 conoce a Raj y en la temporada 8 Raj la presenta como su novia. Desarrolla aversión hacia Penny por haber tenido «algo» con Koothrappali. " +
            ...
            listaActor.add(new Actor(R.drawable.mary,"Mary Cooper","Es una cristiana devota de Texas. Tiene dos hijos además de Sheldon, incluyendo la hermana melliza de este, llamada Missy Cooper . Sheldon tiene una relación muy distante con ella, puesto que son tan " +
            ...
            listaActor.add(new Actor(R.drawable.madreleonard,"Beverly Hofstadter","la madre de Leonard. Es una psiquiatra y neurocientífica insensible y pedante. Mantiene una relación extremadamente distante con Leonard pero se lleva muy bien con Sheldon, " +
