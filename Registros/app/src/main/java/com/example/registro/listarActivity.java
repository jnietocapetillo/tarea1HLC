...
public class listarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // poner actores de the big bang theory
            ...
            final ArrayList<Actor> listaActor = new ArrayList<>();

            listaActor.add(new Actor(R.drawable.sheldon,"Sheldon Cooper (Jim Parsons)","Fue un niño superdotado proveniente del este de Texas. " +
            ...
            listaActor.add(new Actor(R.drawable.leonard,"Leonard Hofstadter (Johnny Galecki)","Es proveniente de New Jersey. Obtuvo su doctorado a los 24 años de edad en la Universidad de Princeton." +
            ...
            listaActor.add(new Actor(R.drawable.penny,"Penny (Kaley Cuoco)","Es proveniente de Nebraska. Es camarera en el restaurante \"The Cheesecake Factory\", hasta " +
            ...
            listaActor.add(new Actor(R.drawable.howard,"Howard Wolowitz (Simon Helberg)","Es judío con apariencia anticuada para su época. Es el único de los cuatro amigos que no tiene un doctorado (solo tiene un máster), " +
            ...
            listaActor.add(new Actor(R.drawable.bernadette,"Bernadette Rostenkowski (Melissa Rauch)","Tiene un doctorado. Se caracteriza por usar gafas y tener vestidos casuales pero similares. Es rubia, guapa y de baja estatura. " +
            ...
            listaActor.add(new Actor(R.drawable.raj,"Raj Koothrappali (Kunal Nayyar)","Es hindú (este personaje representa el estereotipo de un hindú que reside en Estados Unidos). " +
            ...
            listaActor.add(new Actor(R.drawable.stuart,"Stuart Bloom (Kevin Sussman)","Tiene estudios en una escuela de Arte. Es medio nerd, fanático de los cómics y muy buen dibujante. Es el dependiente de la tienda de cómics." +
            ...
            listaActor.add(new Actor(R.drawable.leslie,"Leslie Winkle (Sara Gilbert)","es una físico experimental que tiene sexo casual con Howard y Leonard. No se lleva bien con Sheldon y se burla frecuentemente de él. ", "Secundario"));
            listaActor.add(new Actor(R.drawable.emily,"Emily Sweenney (Laura Spencer)","En la temporada 7 conoce a Raj y en la temporada 8 Raj la presenta como su novia. Desarrolla aversión hacia Penny por haber tenido «algo» con Koothrappali. " +
            ...
            listaActor.add(new Actor(R.drawable.mary,"Mary Cooper (Laurie Metcalf)","Es una cristiana devota de Texas. Tiene dos hijos además de Sheldon, incluyendo la hermana melliza de este, llamada Missy Cooper . Sheldon tiene una relación muy distante con ella, puesto que son tan " +
            ...
            listaActor.add(new Actor(R.drawable.madreleonard,"Beverly Hofstadter (Christine Baranski)","la madre de Leonard. Es una psiquiatra y neurocientífica insensible y pedante. Mantiene una relación extremadamente distante con Leonard pero se lleva muy bien con Sheldon, " +
        ...
        adaptador = new RecyclerViewAdapter(this, listaActor);
        ...
        ((RecyclerViewAdapter) adaptador).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               i.putExtra("nombre", listaActor.get(rcyView.getChildAdapterPosition(v)).getNombre());
               i.putExtra("descripcion", listaActor.get(rcyView.getChildAdapterPosition(v)).getDescripcion());
               i.putExtra("tipo", listaActor.get(rcyView.getChildAdapterPosition(v)).getTipo());
               i.putExtra("imagen", listaActor.get(rcyView.getChildAdapterPosition(v)).getImg());
               startActivity(i);
